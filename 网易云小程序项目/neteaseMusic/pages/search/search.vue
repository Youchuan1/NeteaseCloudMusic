...
<style scoped>
	...
	.search-hot-word image { width: 45rpx; height: 22rpx; }
	.search-hot-count { color: #878787; }
	/*搜索内容*/
	.search-result{ border-top: 2rpx #e4e4e4 solid; padding: 30rpx;}
	.search-result-item{ display: flex; justify-content: space-between; align-items: center; border-bottom: 2rpx #e4e4e4 solid; padding-bottom:30rpx; margin-bottom: 30rpx;}
	...
	.search-suggest-item text{ color: #bdbdbd; margin-right: 28rpx; position: relative; top: 5rpx; }
</style>
